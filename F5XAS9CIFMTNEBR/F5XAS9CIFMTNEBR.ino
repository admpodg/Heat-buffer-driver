...
//used sensor adressess
  DS18B20_table[0] = {{0x28, 0x96, 0x00, 0x00, 0x9A, 0x5C, 0x00, 0x65}, 0, 0xFF}; //why extended init did not work? maybe only during init and def?//C allows nesting, c++ not, that's why
  DS18B20_table[1] = {{0x28, 0xC8, 0x00, 0x00, 0x11, 0x63, 0x00, 0xCE}, 1, 0xFF};
  DS18B20_table[2] = {{0x28, 0x96, 0x00, 0x00, 0x99, 0x46, 0x00, 0x8A}, 2, 0xFF};
  DS18B20_table[3] = {{0x28, 0x96, 0x00, 0x00, 0xB2, 0x4A, 0x00, 0x92}, 3, 0xFF};
  DS18B20_table[4] = {{0x28, 0xAF, 0x00, 0x00, 0xD8, 0x10, 0x01, 0xE8}, 4, 0xFF};
  DS18B20_table[5] = {{0x28, 0xC8, 0x00, 0x00, 0xC6, 0x0C, 0x00, 0xEF}, 5, 0xFF};
  DS18B20_table[6] = {{0x28, 0xC8, 0x00, 0x00, 0x6A, 0x20, 0x00, 0x2E}, 6, 0xFF};
  DS18B20_table[7] = {{0x28, 0xC8, 0x00, 0x00, 0x31, 0x61, 0x00, 0xCB}, 7, 0xFF};
  DS18B20_table[8] = {{0x28, 0x96, 0x00, 0x00, 0xBD, 0x64, 0x00, 0xD0}, 8, 0xFF};
